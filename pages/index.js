...
export default function Home() {
  return (
    <>
      <Head>
        <title>AOS - Presale Sample</title>
        <link rel="stylesheet" href="https://maxst.icons8.com/vue-static/landings/line-awesome/line-awesome/1.3.0/css/line-awesome.min.css" 
        ></link>
        <meta name="description" content="GAOS is a decentralized launchpad that
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="/er21.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/icons/er21.png" />
        <link rel="manifest" href="/icons/site.webmanifest" />
        <link rel="icon" href="/icons/er21.jpg" />
      ...
      <section className={styles.aboutSection} id="about">
        ...
        <div className={styles.aboutTextSection}>
          <h3 className={styles.aboutHeader}>Meet Future AOS</h3>
          <p className={styles.aboutText}>
            We will strive to make AOSChain as one of the prominent
            way Blockchain will be used in different areas of business
            and economy as well as social welfare and other major areas
            of technology
          </p>
          <p className={styles.aboutText}><i className="las la-arrow-right"></i>AOSChain Blockchain</p>
      ...
      <section className={styles.futureSection}>
        ...
        <div className={styles.futureItemBlock}>
          <ul className={styles.futureColumn}>
            <li><i className="las la-star"></i>AOSChain Blockchain</li>
            ...
            <li><i className="las la-star"></i>Audit Platform for AOSChain</li>
      ...
      <section className={styles.aboutSection}>
        <div className={styles.aboutTextSection}>
          ...
          <p className={styles.aboutText}>
            <h2 className="las la-binoculars" style={{ marginBottom: '10px', background: 'linear-gradient(90deg, rgba(4, 197, 210, 1) 0%, rgba(0, 153, 255, 1) 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} > Vision </h2>
            <br />
          ...
          <p className={styles.aboutText}>
            <h2 className="las la-rocket " style={{ marginBottom: '10px', background: 'linear-gradient(90deg, rgba(4, 197, 210, 1) 0%, rgba(0, 153, 255, 1) 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'  }} > Mission</h2>
            <br />
          ...
          <p className={styles.aboutText}>
            <h2 className="las la-lightbulb " style={{ marginBottom: '10px', background: 'linear-gradient(90deg, rgba(4, 197, 210, 1) 0%, rgba(0, 153, 255, 1) 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} > Solution</h2>
            <br />
      ...
      <section className={styles.tokenomicsSection} id="token">
        ...
        <div className={styles.tokenomicsDetailsHolder}>
          <div className={styles.tokenomicsColumn}>
            ...
            <p className={styles.tokenDetailText}>AOS</p>
            ...
            <p className={styles.tokenDetailText}>1st Oct 2025</p>
            <h4 className={styles.tokenDetailHead}>Currencies Accepted</h4>
            <p className={styles.tokenDetailText}>SOL</p>
          </div>
          <div className={styles.tokenomicsColumn}>
            <h4 className={styles.tokenDetailHead}>ICO Pre- Sale AOS Supply Launch</h4>
            <p className={styles.tokenDetailText}>200,000,000,000,000</p>
            <h4 className={styles.tokenDetailHead}>ICO Supply OF AOS launch</h4>
            <p className={styles.tokenDetailText}>200,000,000,000,000</p>
            ...
            <p className={styles.tokenDetailText}>1st of Jan 2026</p>
          </div>
          <div className={styles.tokenomicsColumn}>
            <h4 className={styles.tokenDetailHead}>Pre Sale - 1st Phase</h4>
            <p className={styles.tokenDetailText}>1 SOL = 2,600,000,000 AOS</p>
            <h4 className={styles.tokenDetailHead}>Pre Sale - 2nd Phase</h4>
            <p className={styles.tokenDetailText}>1 SOL = 1,300,000,000 AOS</p>
            <h4 className={styles.tokenDetailHead}>Pre Sale - 3rd Phase</h4>
            <p className={styles.tokenDetailText}>1 SOL = 650,000,000 AOS</p>
            <h4 className={styles.tokenDetailHead}>Pre Sale- 4th phase</h4>
            <p className={styles.tokenDetailText}>	1 SOL = 325,000,000 AOS</p>
          </div>
        </div>
        ...
        <div className={styles.timeline}>
          <div className={[styles.container, styles.left].join(" ")}>
            ...
            <div className={styles.content}>
              <p>
                <ul>
                  <li>Ideation of AOS Blockhain and AOS
                  </li>
          ...
          <div className={[styles.container, styles.right].join(" ")}>
            ...
            <div className={styles.content}>
              <p>
                <ul>
                  <li>ICO website Development For AOS
                  </li>
          ...
          <div className={[styles.container, styles.left].join(" ")}>
            <div className={styles.date}>Oct-Dec 2025</div>
            <i className="icon ri-heart-line"></i>
            <div className={styles.content}>
              <p>
                <ul>
                  <li>Start AOS Chain Development
                  </li>
                  <li>Pre-Sale Stage 2
                  </li>
          ...
          <div className={[styles.container, styles.right].join(" ")}>
            <div className={styles.date}>Jan-March 2026</div>
            <i className="icon ri-heart-line"></i>
            <div className={styles.content}>
              <p>
                <ul>
                  <li>AOS Launch to general Public
                  </li>
          ...
          <div className={[styles.container, styles.left].join(" ")}>
            <div className={styles.date}>April-June 2026</div>
            <i className="icon ri-heart-line"></i>
            <div className={styles.content}>
              <p>
                <ul>
          ...
          <div className={[styles.container, styles.right].join(" ")}>
            <div className={styles.date}>July-Sept 2026</div>
            <i className="icon ri-heart-line"></i>
            <div className={styles.content}>
              <p>
                <ul>
                  <li>AOS Exchange Beta Version Release
                  </li>
          ...
          <div className={[styles.container, styles.left].join(" ")}>
            <div className={styles.date}>Oct-Dec 2026</div>
            <i className="icon ri-heart-line"></i>
            <div className={styles.content}>
              <p>
                <ul>
      ...
      <section className={styles.whySection}>
        ...
        <div className={styles.whyImageSection}>
          <img src="/kredict-white.png" alt="AOS icon" />
        </div>
      </section>
      {/* why-section-- */}
      {/* team-section------ */}
        ...
        <div className={styles.whitepaperBlock}>
          <div className={styles.whitepaperTextSection}>
            ...
            <p className={styles.whitepaperText}>
              Total of 1 quadrillion (1,000,000,000,000,000) AOSs will be minted through
              ...
              kept the investment amount to minimum 0.1 SOL for our presale which will make easy for
      ...
      <section className={styles.contactSection} id="contact">
        <div className={styles.contactSocialSide}>
          ...
          <div className={styles.contactSocialBlock}>
            <Link href="mailto:support@aos.co"><a target="_blank" rel="noreferrer"><i className="las la-envelope"></i>support@aos.co</a></Link>
            <Link href="https://t.me/ermiasbe"><a target="_blank" rel="noreferrer"><i className="lab la-telegram"></i>Telegram</a></Link>
            <Link href="https://twitter.com/"><a target="_blank" rel="noreferrer"><i className="lab la-twitter-square"></i>X</a></Link>
            <Link href="https://www.instagram.com/"><a target="_blank" rel="noreferrer"><i className="lab la-instagram"></i>Instagram</a></Link>
            <Link href="https://www.youtube.com/"><a target="_blank" rel="noreferrer"><i className="lab la-youtube"></i>YouTube</a></Link>
          </div>
        </div>
      ...
      <section className={styles.footerSection}>
        <div className={styles.brandFooter}>
          ...
          <p className={styles.brandText}><Link href="https://t.me/ermiasbe"><a target="_blank" rel="noreferrer">AOS</a></Link></p>
        </div>
      </section>
      {/* footer--------- */}
